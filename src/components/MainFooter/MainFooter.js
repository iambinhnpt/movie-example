      ...
      <footer className="main-footer">
        <section className="main-footer-top">
          <header className="main-footer-top-header">
            ...
            <nav className="main-footer-top-header-nav">
              ...
              <a
                ...
                data-wow-delay="1.1s"
                data-wow-duration="1.2s"
                href="https://www.termsfeed.com/terms-conditions/03b187ec0a7e3e1daf949a9c83615051"
                to="/discover"
              >
                FAQ
              </a>
              <a
                ...
                data-wow-delay="1.1s"
                data-wow-duration="1.2s"
                href="https://www.termsfeed.com/privacy-policy/19ee9e5044a2da9d21da854d0de4f914"
                to=""
              >
                Privacy
              </a>
          ...
          <div className="main-footer-top-item">
            ...
            <p>
              <a
                href="cybersoft.edu.vn"
                target="_blank"
                rel="noopener noreferrer"
              >
                {svg.plane} cybersoft.edu.vn
              </a>
            </p>
          </div>
        </section>
            ...
            <div className="col-sm-4 col-xs-12 hideOnMobile">
              ...
              <div className="row col-sm-12 col-xs-12 linePartner">
                <a target="_blank" href="http://bhdstar.vn" title="BHD">
                  <img
                    ...
                    src="https://123phim.vn/app/assets/img/icons/bhd.png"
                  />
                </a>
                <a target="_blank" href="http://galaxycine.vn" title="Galaxy">
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/galaxycine.png"
                  />
                </a>
                <a
                  target="_blank"
                ...
                >
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/cinestar.png"
                  />
                </a>
                <a
                  target="_blank"
                ...
                >
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/megags.png"
                  />
                </a>
              </div>
              <div className="row col-sm-12 col-xs-12 linePartner">
                ...
                >
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/bt.jpg"
                  />
                </a>
                <a
                  target="_blank"
                ...
                >
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/dongdacinema.png"
                  />
                </a>
                <a
                  target="_blank"
                ...
                >
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/TOUCH.png"
                  />
                </a>
                <a
                  target="_blank"
                ...
                >
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/cnx.jpg"
                  />
                </a>
              ...
              <div className="row col-sm-12 col-xs-12 linePartner">
                <a target="_blank" href="https://momo.vn" title="MoMo">
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/momo.png"
                  />
                </a>
                ...
                <a target="_blank" href="https://www.payoo.vn/" title="Payoo">
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/payoo.jpg"
                  />
                </a>
                <a
                  target="_blank"
                ...
                >
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/VCB.png"
                  />
                </a>
                <a
                  target="_blank"
                ...
                >
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/AGRIBANK.png"
                  />
                </a>
              </div>
              <div className="row col-sm-12 col-xs-12 linePartner">
                ...
                >
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/VIETTINBANK.png"
                  />
                </a>
                <a
                  target="_blank"
                ...
                >
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/IVB.png"
                  />
                </a>
                <a target="_blank" href="http://123go.vn" title="123Go">
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/123go.png"
                  />
                </a>
                <a target="_blank" href="http://laban.vn" title="La Bàn">
                  <img
                    className="iconConnect"
                    src="https://123phim.vn/app/assets/img/icons/laban.png"
                  />
                </a>
              </div>
        ...
        <section className="main-footer-bottom">
          <img
            className="main-footer-bottom-section-1 wow fadeInUp"
            data-wow-delay=".5s"
            data-wow-duration="1.2s"
            src={TMDBLogo}
            alt="TMDB Logo"
          ...
          <div className="main-footer-bottom-section-2">
            ...
            >
              <svg
                className="main-footer-bottom-section-2__icon wow fadeInUp"
                data-wow-delay=".7s"
                data-wow-duration="1.2s"
